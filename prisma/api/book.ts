...
import { BookDetail, Chapter } from "../prismaContext"

const { debug, info, err } = useDebug("prisma/api/book", "DEBUG")

debug("BookApi")

const notEmpty = (arr: Array<any> | undefined | null) =>
...
const like = async (bookDetail: BookDetail, userId: string) => {
...
const share = async (bookDetail: BookDetail, userId: string) => {
...
const addGallery = async (bookDetail: BookDetail, galleryId?: string) => {
